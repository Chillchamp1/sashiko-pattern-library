...
| **3b** | Waves v2 | `waves2` | Contour waves exactly as mode 3 builds them, ordered with the robust band-snake (`_v2OrderFamily`: **gap-clustered** centroid bands with **rank** parity, movement-type + 30° orientation bins, v1 ordering and NN as fallback candidates — the most **predictable** within 15 % of the cheapest score) instead of the fragile min-gap pitch. |
